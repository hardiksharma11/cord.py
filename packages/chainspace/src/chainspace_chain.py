...
async def get_uri_for_space(space_digest, creator_uri):
    ...
    scale_encoded_auth_digest = api.create_type('Bytes', uri_to_identifier(chain_space_uri))
    scale_encoded_auth_delegate = api.create_type('AccountId', to_chain(creator_uri))
